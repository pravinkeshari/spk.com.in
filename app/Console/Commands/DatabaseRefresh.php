    ...
    public function handle(): void
    {
        ...
        try {
            if (!in_array(request()->ip(), ['127.0.0.1', '::1'])) {
                $recaptcha = \App\Models\BusinessSetting::where('type', 'recaptcha')->first()?->value ?? '';
                ...
                \App\Models\BusinessSetting::where('type', 'recaptcha')->update(['type' =>'recaptcha', 'value' => $value]);
            }
