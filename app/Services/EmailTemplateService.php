...
class EmailTemplateService
{
    ...
    public function getUpdateData(object $request, $template): array
    {
        ...
        $bannerImage = $request['banner_image'] ? $this->update(dir: 'email-template/', oldImage: $template['banner_image'], format: 'png', image: $request->file('banner_image')) : $template['banner_image'];
        return [
