                ...
                <div class="card">
                    <div class="card-body text-start">
                        <div class="mb-20">
                            ...
                            <p class="fs-12 mb-0">
                                {{ translate('create_and_manage_your_categories_easily') }}
                            </p>
                        </div>
                                    ...
                                    <div class="bg-section rounded-8 p-20 w-100 h-100">
                                        <div class="table-responsive w-auto overflow-y-hidden mb-20">
                                            <div class="position-relative nav--tab-wrapper">
                                                <ul class="nav nav-pills nav--tab lang_tab" id="pills-tab"
                                                    role="tablist">
                                        ...
                                        <div class="tab-content" id="pills-tabContent">
                                            @foreach($languages as $lang)
                                                <div
                                                    class="form-group mb-3 tab-pane fade {{ $lang == $defaultLanguage ? 'show active' : '' }}"
                                                    id="{{ $lang }}-form" aria-labelledby="{{ $lang }}-link"
                                                    role="tabpanel">
                                                    <label
                                                        class="form-label text-capitalize">{{ translate('category_Name') }}
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label text-capitalize"
                                                   for="priority">{{ translate('priority') }}
                                        ...
                                        @if (isset($categoryWiseTax) && $categoryWiseTax)
                                            <div class="form-group mb-0">
                                                <label class="form-label" for="">
                                                    {{ translate('Select_Vat/Tax_Rate') }}
                                                </label>

                                                <select class="custom-select multiple-select2" id="" name="tax_ids[]"
                                                        multiple="multiple"
