        ...
        <div class="pt-4 pb-60">
            <dl>
                ...
                <div class="d-flex gap-2 border-top justify-content-between pt-2">
                    ...
                    <dd class="font-weight-bold title-color">{{setCurrencySymbol(amount: usdToDefaultCurrency(amount: ($cartItems['total'] + ($cartItems['totalTax'] ?? 0) - $cartItems['couponDiscount'])), currencyCode: getCurrencyCode())}}</dd>
                </div>
            </dl>
