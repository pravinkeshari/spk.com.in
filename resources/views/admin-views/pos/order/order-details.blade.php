                            ...
                            <table class="table table-borderless table-sm mb-0 text-sm-right text-nowrap">
                                ...
                                <tr>
                                    <td class="text-end text-body text-capitalize">
                                        <strong>{{ translate('item_price') }}</strong></td>
                                ...
                                <tr>
                                    <td class="text-end text-body text-capitalize">
                                        <strong>{{ translate('item_discount') }}</strong></td>
                                    <td class="text-end text-dark">
                                        -
                                ...
                                <tr>
                                    <td class="text-end text-body"><strong>{{ translate('extra_discount') }}</strong>
                                    </td>
                                    <td class="text-end text-dark">
                                ...
                                <tr>
                                    <td class="text-end text-body text-capitalize">
                                        <strong>{{ translate('sub_total') }}</strong></td>
                                    <td class="text-end text-dark">
                                ...
                                <tr>
                                    <td class="text-end text-body"><strong>{{ translate('coupon_discount') }}</strong>
                                    </td>
                                    <td class="text-end text-dark">
                                        <strong>-
                                ...
                                @if($orderTotalPriceSummary['referAndEarnDiscount'] > 0)
                                    <tr>
                                        <td class="text-end text-body">
                                            <strong>{{ translate('referral_discount') }}</strong></td>
                                        <td class="text-end text-dark">
                                            <strong>-
                                ...
                                @endif
                                <tr>
                                    <td class="text-end text-body text-uppercase"><strong>{{ translate('vat') }}
                                            /{{ translate('tax') }}</strong></td>
                                    <td class="text-end text-dark">
                                ...
                                @if ($order->order_type == 'pos' || $order->order_type == 'POS')
                                    <tr>
                                        <td class="text-end text-body"><strong>{{ translate('paid_amount') }}</strong>
                                        </td>
                                        <td class="text-end text-dark">
                                    ...
                                    <tr>
                                        <td class="text-end text-body"><strong>{{ translate('change_amount') }}</strong>
                                        </td>
                                        <td class="text-end text-dark">
